    ...
    jQuery('.datepicker-holder').each(function () {
        ...
        inputs.datepicker({
            ...
            onSelect: function (selectedDate) {
                ...
                if (input.is(from)) {
                    //abe++
                    if (to.attr('type') === 'text') {//Days are displayed range mode (kisaan.days_display_mode: range)
                        setTimeout(function () {
                            to.focus();
                        }, 100);
...
function syncTimeFields(parentTimesElt) {
    $(parentTimesElt).each(function () {
        ...
        //Times are displayed in duration mode (kisaan.times_display_mode: duration)
