...
namespace Kisaan\CMSBundle\Model\Manager;

use Kisaan\CMSBundle\Entity\Footer;
use Kisaan\CMSBundle\Repository\FooterRepository;
use Kisaan\CoreBundle\Utils\UriHasher;
use Kisaan\SeoBundle\Entity\ContentTranslation;
...
class FooterManager
{
    ...
    {
        return $this->em->getRepository('KisaanCMSBundle:Footer');
    }
}
