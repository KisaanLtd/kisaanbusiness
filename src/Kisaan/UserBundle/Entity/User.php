...
namespace Kisaan\UserBundle\Entity;

use Kisaan\CoreBundle\Entity\Booking;
use Kisaan\CoreBundle\Entity\BookingBankWire;
...
use Kisaan\ReviewBundle\Entity\Review;
use Kisaan\UserBundle\Model\BookingDepositRefundAsAskerInterface;
use Kisaan\UserBundle\Model\BookingDepositRefundAsOffererInterface;
use Kisaan\UserBundle\Model\ListingAlertInterface;
use Kisaan\UserBundle\Model\UserCardInterface;
use Kisaan\UserBundle\Validator\Constraints as KisaanUserAssert;
use DateTime;
 ...
 * User.
 *
 * @KisaanUserAssert\User()
 *
 * @ORM\Entity(repositoryClass="Kisaan\UserBundle\Repository\UserRepository")
 *
 * @UniqueEntity(
 *      fields={"email"},
 *      groups={"KisaanRegistration", "KisaanProfile", "KisaanProfileContact", "default"},
 *      message="kisaan_user.email.already_used"
 * )
 *
 * @UniqueEntity(
 *      fields={"username"},
...
class User extends BaseUser implements ParticipantInterface
{
     ...
     * @ORM\CustomIdGenerator(class="Kisaan\CoreBundle\Model\CustomIdGenerator")
     *
     * @var int
     */
    protected $id;
     ...
     * @var string
     *
     * @Assert\Email(message="kisaan_user.email.invalid", strict=true, groups={"KisaanRegistration", "KisaanProfile", "KisaanProfileContact"})
     *
     * @Assert\NotBlank(message="kisaan_user.email.blank", groups={"KisaanRegistration", "KisaanProfile", "KisaanProfileContact"})
     *
     * @Assert\Length(
     *     min=3,
     *     max="255",
     *     minMessage="kisaan_user.username.short",
     *     maxMessage="kisaan_user.username.long",
     *     groups={"KisaanRegistration", "KisaanProfile", "KisaanProfileContact"}
     * )
     */
    protected $email;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.last_name.blank", groups={
     *  "KisaanRegistration", "KisaanProfile", "KisaanProfileBankAccount"
     * })
     *
     * @Assert\Length(
     *     min=3,
     *     max="100",
     *     minMessage="kisaan_user.last_name.short",
     *     maxMessage="kisaan_user.last_name.long",
     *     groups={"KisaanRegistration", "KisaanProfile", "KisaanProfileBankAccount"}
     * )
     */
    protected $lastName;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.first_name.blank", groups={
     *  "KisaanRegistration", "KisaanProfile", "KisaanProfileBankAccount"
     * })
     *
     * @Assert\Length(
     *     min=3,
     *     max="100",
     *     minMessage="kisaan_user.first_name.short",
     *     maxMessage="kisaan_user.first_name.long",
     *     groups={"KisaanRegistration", "KisaanProfile", "KisaanProfileBankAccount"}
     * )
     */
    protected $firstName;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.birthday.blank", groups={
     *  "KisaanRegistration", "KisaanProfileBankAccount"
     * })
     */
    protected $birthday;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.country_of_residence.blank", groups={
     *  "KisaanRegistration", "KisaanProfileBankAccount"
     * })
     */
     ...
     *
     * @Assert\Iban(message = "kisaan_user.iban.invalid", groups={
     *  "KisaanProfileBankAccount"
     * }))
     *
     * @Assert\NotBlank(message="kisaan_user.iban.blank", groups={
     *  "KisaanProfileBankAccount"
     * })
     */
    protected $iban;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.bic.blank", groups={
     *  "KisaanProfileBankAccount"
     * })
     */
    protected $bic;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.bank_owner_name.blank", groups={
     *  "KisaanProfileBankAccount"
     * })
     */
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.bank_owner_address.blank", groups={
     *  "KisaanProfileBankAccount"
     * })
     */
     ...
     * @Assert\Length(
     *      min = 6,
     *      minMessage = "{{ limit }}kisaan_user.password.short",
     * )
     *
     * @var string
     */
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.motherTongue.blank", groups={"KisaanProfile"})
     *
     * @var string
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\MessageBundle\Entity\Message", mappedBy="sender", cascade={"remove"}, orphanRemoval=true)
     */
    private $messages;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\ReviewBundle\Entity\Review", mappedBy="reviewBy", cascade={"remove"}, orphanRemoval=true)
     * @ORM\OrderBy({"createdAt" = "desc"})
     */
    private $reviewsBy;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\ReviewBundle\Entity\Review", mappedBy="reviewTo", cascade={"remove"}, orphanRemoval=true)
     * @ORM\OrderBy({"createdAt" = "desc"})
     */
    private $reviewsTo;

    /**
     * @ORM\OneToOne(targetEntity="Kisaan\UserBundle\Entity\UserFacebook", mappedBy="user", cascade={"remove"}, orphanRemoval=true)
     */
    private $userFacebook;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Entity\Listing", mappedBy="user", cascade={"persist", "remove"})
     * @ORM\OrderBy({"createdAt" = "desc"})
     *
     * @var Listing[]
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\UserBundle\Entity\UserAddress", mappedBy="user", cascade={"persist", "remove"})
    ...
    /**
     * For Asserts : @see \Kisaan\UserBundle\Validator\Constraints\UserValidator.
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Entity\Booking", mappedBy="user", cascade={"persist", "remove"}, orphanRemoval=true)
     * @ORM\OrderBy({"createdAt" = "desc"})
     *
     * @var Booking[]
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Entity\BookingBankWire", mappedBy="user", cascade={"persist", "remove"})
     * @ORM\OrderBy({"createdAt" = "desc"})
     *
     * @var BookingBankWire[]
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Entity\BookingPayinRefund", mappedBy="user", cascade={"persist", "remove"})
     * @ORM\OrderBy({"createdAt" = "desc"})
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\UserBundle\Model\ListingAlertInterface", mappedBy="user", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $listingAlerts;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\UserBundle\Model\BookingDepositRefundAsAskerInterface", mappedBy="asker", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $bookingDepositRefundsAsAsker;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\UserBundle\Model\BookingDepositRefundAsOffererInterface", mappedBy="offerer", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $bookingDepositRefundsAsOfferer;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\UserBundle\Model\UserCardInterface", mappedBy="user", cascade={"persist", "remove"}, orphanRemoval=true)
     ...
     *
     * @Assert\Callback(groups={"KisaanRegistration", "KisaanProfile", "KisaanProfileContact", "default"},)
     */
    public function validate(ExecutionContextInterface $context)
    {
        if ($this->personType == self::PERSON_TYPE_LEGAL && empty($this->companyName)) {
            $context->buildViolation('kisaan_user.company_name.blank')
                ->atPath('companyName')
