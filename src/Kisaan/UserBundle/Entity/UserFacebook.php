 ...
 * UserFacebook
 *
 * @ORM\Entity(repositoryClass="Kisaan\UserBundle\Repository\UserFacebookRepository")
 *
 * @UniqueEntity(
 *      fields={"email"},
...
class UserFacebook
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Kisaan\UserBundle\Entity\User", inversedBy="userFacebook")
     ...
     * @var string
     *
     * @Assert\Email(message="kisaan_user.email.invalid", groups={"KisaanRegistration", "KisaanProfile"})
     *
     * @Assert\NotBlank(message="kisaan_user.email.blank", groups={"KisaanRegistration", "KisaanProfile"})
     *
     */
    protected $email;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.last_name.blank", groups={"KisaanRegistration", "KisaanProfile"})
     *
     * @Assert\Length(
     *     min=3,
     *     max="100",
     ...
     *     groups={"KisaanRegistration", "KisaanProfile"}
     * )
     */
    protected $lastName;
     ...
     *
     * @Assert\NotBlank(message="kisaan_user.first_name.blank", groups={"KisaanRegistration", "KisaanProfile"})
     *
     * @Assert\Length(
     *     min=3,
     *     max="100",
