...
use Kisaan\UserBundle\Entity\UserFacebook;
use Kisaan\UserBundle\Entity\UserImage;
use Kisaan\UserBundle\Entity\UserTranslation;
use Kisaan\UserBundle\Event\UserEvent;
use Kisaan\UserBundle\Event\UserEvents;
use Kisaan\UserBundle\Repository\UserFacebookRepository;
...
class UserManager extends BaseUserManager implements UserManagerInterface
{
    ...
    public function checkAndCreateOrUpdateUserByOAuth(UserResponseInterface $response)
    {
        ...
        if (isset($responseArray['id'])) {
            ...
            $facebookRepository = $this->objectManager->getRepository('KisaanUserBundle:UserFacebook');
...
//        curl_setopt($ch, CURLOPT_VERBOSE, true);   // Enable this line to see debug prints
    ...
    {
        return $this->objectManager->getRepository('KisaanUserBundle:User');
    }
