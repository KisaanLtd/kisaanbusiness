...
namespace Kisaan\UserBundle\Command;
...
class ResetNbBookingsCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('kisaan_user:reset_nb_bookings')
            ->setDescription(
                'Reset nb bookings as asker and offerer'
            )
            ->setHelp("Usage php bin/console kisaan_user:reset_nb_bookings");
    }
...
//        return false;
        ...
        $em->createQueryBuilder()
            ->update('KisaanUserBundle:User', 'u')
        ...
        //Set to nb bookings
        $bookingRepo = $em->getRepository('KisaanCoreBundle:Booking');
