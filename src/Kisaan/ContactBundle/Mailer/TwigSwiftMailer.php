...
class TwigSwiftMailer implements MailerInterface
{
    ...
    public function __construct(
        ...
        $this->fromEmail = $parameters['parameters']['kisaan_contact_from_email'];
        $this->contactEmail = $parameters['parameters']['kisaan_contact_contact_email'];
        $this->templates = $templates;
        $this->locale = $parameters['parameters']['kisaan_locale'];
    }
