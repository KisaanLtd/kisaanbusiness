...
namespace Kisaan\ReviewBundle\Admin;
...
class ReviewAdmin extends AbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        if ($review) {
            ...
            $bookingQuery = $this->modelManager->getEntityManager('KisaanCoreBundle:Booking')
                ->getRepository('KisaanCoreBundle:Booking')
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add(
                ...
                null,
                array(
                    'template' => 'KisaanReviewBundle:Admin:list_comment.html.twig',
                    'label' => 'admin.review.comment.label',
                )
            )
            ->add(
