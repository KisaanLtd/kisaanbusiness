...
namespace Kisaan\ReviewBundle\Extension;
...
class StarRatingTwigExtension extends \Twig_Extension implements \Twig_Extension_GlobalsInterface
{
    ...
    public function getFilters()
    {
        return array(
            new \Twig_SimpleFilter(
                'kisaan_star_rating', array($this, 'starRatingFilter'),
    ...
    {
        return $env->render('KisaanReviewBundle:Frontend/Twig:star_rating.html.twig', array('rating' => $rating));
    }

    /** @inheritdoc */
    public function getName()
    {
        return 'kisaan_star_rating';
    }
