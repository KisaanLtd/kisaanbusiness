...
use Kisaan\ReviewBundle\Repository\ReviewRepository;
...
class ReviewManager extends BaseManager
{
    ...
    public function getUnreviewedBookings($userType, User $user)
    {
        ...
        $bookingRepository = $this->em->getRepository('KisaanCoreBundle:Booking');
    ...
    {
        return $this->em->getRepository('KisaanReviewBundle:Review');
    }
}