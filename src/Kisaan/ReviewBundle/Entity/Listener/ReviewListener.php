 ...
 */
namespace Kisaan\ReviewBundle\Entity\Listener;
...
class ReviewListener
{
    ...
    public function postPersist(Review $review, LifecycleEventArgs $args)
    {
        ...
        // update user ratings
        $userReviews = $em->getRepository('KisaanReviewBundle:Review')->getUserAverage($review);

        // update listing ratings
        $listingReviews = $em->getRepository('KisaanReviewBundle:Review')->getListingAverage($review);
