 ...
 * Department
 *
 * @ORM\Entity(repositoryClass="Kisaan\GeoBundle\Repository\DepartmentRepository")
 *
...
class Department
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Country", inversedBy="departments", cascade={"persist"})
     ...
     * @Assert\NotBlank(message="assert.not_blank")
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Area", inversedBy="departments", cascade={"persist"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\GeoBundle\Entity\City", mappedBy="department", cascade={"persist", "remove"})
     **/
    private $cities;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\GeoBundle\Entity\Coordinate", mappedBy="department", cascade={"persist", "remove"})
     **/
    private $coordinates;
