 ...
 * City
 *
 * @ORM\Entity(repositoryClass="Kisaan\GeoBundle\Repository\CityRepository")
 *
...
class City
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Country", inversedBy="cities", cascade={"persist"})
     ...
     * @Assert\NotBlank(message="assert.not_blank")
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Area", inversedBy="cities", cascade={"persist"})
     ...
     * @Assert\NotBlank(message="assert.not_blank")
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Department", inversedBy="cities", cascade={"persist"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\GeoBundle\Entity\Coordinate", mappedBy="city", cascade={"persist", "remove"})
     **/
    private $coordinates;
