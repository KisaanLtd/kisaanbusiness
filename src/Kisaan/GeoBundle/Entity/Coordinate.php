 ...
 * Coordinate
 *
 * @ORM\Entity(repositoryClass="Kisaan\GeoBundle\Repository\CoordinateRepository")
 *
...
class Coordinate
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Country", inversedBy="coordinates", cascade={"persist"})
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Area", inversedBy="coordinates", cascade={"persist"})
     ...
     * @Assert\NotBlank(message="assert.not_blank")
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\Department", inversedBy="coordinates", cascade={"persist"})
     ...
     * @Assert\NotBlank(message="assert.not_blank")
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\GeoBundle\Entity\City", inversedBy="coordinates", cascade={"persist"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Entity\ListingLocation", mappedBy="coordinate", cascade={"persist", "remove"})
     **/
     ...
     * Get area
     *
     * @return \Kisaan\GeoBundle\Entity\Area
     */
     ...
     * Get department
     *
     * @return \Kisaan\GeoBundle\Entity\Department
     */
     ...
     * Get city
     *
     * @return \Kisaan\GeoBundle\Entity\City
     */
     ...
     * Add listingLocation
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingLocation $listingLocation
     * @return Coordinate
     */
