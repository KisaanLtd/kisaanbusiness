...
namespace Kisaan\CoreBundle\Mailer;
...
{
    const TRANS_DOMAIN = 'kisaan_mail';
    ...
    public function __construct(
        ...
        $this->fromEmail = $parameters['kisaan_from_email'];
        $this->adminEmail = $parameters['kisaan_contact_email'];
        ...
        $this->locale = $parameters['kisaan_locale'];
    ...
    public function sendWireTransferMessageToOfferer(Booking $booking)
    {
        ...
        $paymentOffererUrl = $this->router->generate(
            'kisaan_dashboard_booking_bank_wire_offerer',
            array(
                '_locale' => $userLocale
            ),
            UrlGeneratorInterface::ABSOLUTE_URL
...
//        $this->sendMessage($template, $context, $this->fromEmail, $user->getEmail());
    ...
    public function sendBookingAcceptedMessageToAsker(Booking $booking)
    {
        ...
        $paymentAskerUrl = $this->router->generate(
            'kisaan_dashboard_booking_payin_asker',
            array(
                '_locale' => $userLocale
            ),
            UrlGeneratorInterface::ABSOLUTE_URL
