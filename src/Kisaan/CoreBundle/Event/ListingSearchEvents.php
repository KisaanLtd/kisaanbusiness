...
class ListingSearchEvents
{
     ...
     * The event listener method receives a Kisaan\CoreBundle\Event\ListingSearchEvent instance.
     *
     * todo: Renamed to LISTING_SEARCH_QUERY
     */
    const LISTING_SEARCH = 'kisaan.listing_search';
     ...
     * The event listener method receives a Kisaan\CoreBundle\Event\ListingSearchActionEvent instance.
     */
    const LISTING_SEARCH_ACTION = 'kisaan.listing_search.action';
     ...
     * The event listener method receives a Kisaan\CoreBundle\Event\ListingSearchEvent instance.
     */
    const LISTING_SEARCH_HIGH_RANK_QUERY = 'kisaan.listing_search_high_rank.query';
     ...
     * The event listener method receives a Kisaan\CoreBundle\Event\ListingSearchEvent instance.
     */
    const LISTING_SEARCH_BY_IDS_QUERY = 'kisaan.listing_search_by_ids.query';
}