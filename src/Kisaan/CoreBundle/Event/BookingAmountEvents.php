...
class BookingAmountEvents
{
     ...
     * The event listener method receives a Kisaan\CoreBundle\Event\BookingAmountEvent instance.
     */
    const BOOKING_PRE_AMOUNTS_SETTING = 'kisaan.booking.pre_amounts_settings';
     ...
     * The event listener method receives a Kisaan\CoreBundle\Event\BookingAmountEvent instance.
     */
    const BOOKING_POST_AMOUNTS_SETTING = 'kisaan.booking.post_amounts_settings';
