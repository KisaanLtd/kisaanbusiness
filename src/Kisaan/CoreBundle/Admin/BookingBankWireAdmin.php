...
use Kisaan\CoreBundle\Model\Manager\BookingBankWireManager;
        ...
        $listMapper
            ...
            ->add(
                ...
                array(
                    ...
                    'label' =>
                        (
                        array_key_exists("KisaanVoucherBundle", $this->bundles) ?
        ...
        $listMapper->add(
            ...
            array(
                'actions' => array(
                    'edit' => array(),
//                    'do_bank_wire' => array(
//                        'template' => 'KisaanMangoPayBundle::Admin/list_action_do_bank_wire.html.twig'
//                    )
                )
            )
        );
    ...
    protected function configureRoutes(RouteCollection $collection)
    {
        ...
        if (array_key_exists("KisaanMangoPayBundle", $this->bundles)) {
            $collection->add(
                'mangopay_withdraw'//See Kisaan/SonataAdminBundle/Resources/views/CRUD/base_edit_form.html.twig
            );
        }
    }
}
