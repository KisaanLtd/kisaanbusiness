...
use Kisaan\CoreBundle\Form\Type\ListingImageType;
...
//            )
        ...
        if (array_key_exists("KisaanCarrierBundle", $this->bundles)) {
            $formMapper
        ...
        if ($this->isGranted('ROLE_ALLOWED_TO_SWITCH')) {
            $listMapper
                ->add(
                    ...
                    'string',
                    array(
                        'template' => 'KisaanSonataAdminBundle::impersonating.html.twig',
                    )
                );
        }
