...
class BookingAdmin extends AbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        if ($booking) {
            ...
            $listingRepository = $this->modelManager->getEntityManager('KisaanCoreBundle:Listing')
                ->getRepository('KisaanCoreBundle:Listing');
        ...
        if (array_key_exists("KisaanVoucherBundle", $this->bundles)) {
            $formMapper
                ->add(
                    'codeVoucher',
                    null,
        ...
        if (array_key_exists("KisaanListingDepositBundle", $this->bundles)) {
            $formMapper
                ->add(
                    ...
                    array(
                        'translation_domain' => 'kisaan_listing_deposit',
                    )
                );
        }
        ...
        if (array_key_exists("KisaanDeliveryBundle", $this->bundles)) {
            $formMapper
                ...
                ->end();
        } elseif (array_key_exists("KisaanCarrierBundle", $this->bundles)) {
            $formMapper
                ->with('admin.booking.delivery')
                ->add(
                ...
                ->add(
                    ...
                    array(
                        'translation_domain' => 'kisaan_carrier_listing',
                    )
                )
                ->add(
                    'deliveryAddress',
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add(
                ...
                array(
                    'label' => 'admin.booking.status.label',
                    'template' => 'KisaanSonataAdminBundle::list_field_value_translated.html.twig',
                    'data_trans' => 'kisaan_booking'
                )
            )
            ->add(
                'validated',
        ...
        $listMapper
            ->add(
                ...
                null,
                array(
                    'template' => 'KisaanSonataAdminBundle::list_booking_expiration_date.html.twig',
                    'label' => 'admin.booking.expire_at.label',
