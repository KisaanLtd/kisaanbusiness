...
use Kisaan\CoreBundle\Model\BaseBookingPayinRefund;
 ...
 * BookingPayinRefund
 *
 * @ORM\Entity(repositoryClass="Kisaan\CoreBundle\Repository\BookingPayinRefundRepository")
 *
...
class BookingPayinRefund extends BaseBookingPayinRefund
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\UserBundle\Entity\User", inversedBy="bookingPayinRefunds")
    ...
    /**
     * @ORM\OneToOne(targetEntity="Kisaan\CoreBundle\Entity\Booking", inversedBy="payinRefund")
