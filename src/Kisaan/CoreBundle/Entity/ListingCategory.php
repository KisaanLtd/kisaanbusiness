...
use Kisaan\CoreBundle\Model\BaseListingCategory;
use Kisaan\CoreBundle\Model\ListingCategoryListingCategoryFieldInterface;
 ...
 *
 * @ORM\Entity(repositoryClass="Kisaan\CoreBundle\Repository\ListingCategoryRepository")
 *
...
class ListingCategory extends BaseListingCategory
{
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Entity\ListingListingCategory", mappedBy="category", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $listingListingCategories;

    /**
     *
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Model\ListingCategoryListingCategoryFieldInterface", mappedBy="category", cascade={"persist", "remove"})
     */
    private $fields;
     ...
     * Set parent
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingCategory $parent
     ...
     * Get parent
     *
     * @return \Kisaan\CoreBundle\Entity\ListingCategory
     */
     ...
     * Add children
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingCategory $children
     * @return ListingCategory
     */
