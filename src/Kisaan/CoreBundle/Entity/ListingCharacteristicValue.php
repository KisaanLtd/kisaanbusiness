 ...
 *
 * @ORM\Entity(repositoryClass="Kisaan\CoreBundle\Repository\ListingCharacteristicValueRepository")
 *
...
class ListingCharacteristicValue
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\CoreBundle\Entity\ListingCharacteristicType", inversedBy="listingCharacteristicValues")
     ...
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingListingCharacteristic $listingListingCharacteristics
