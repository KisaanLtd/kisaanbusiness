...
class ListingListingCategory
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\CoreBundle\Entity\ListingCategory", inversedBy="listingListingCategories")
     * @ORM\JoinColumn(name="listing_category_id", referencedColumnName="id", nullable=false, onDelete="CASCADE")
     */
    private $category;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Model\ListingCategoryFieldValueInterface", mappedBy="listingListingCategory", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $values;
