...
use Kisaan\CoreBundle\Model\BaseBookingBankWire;
 ...
 * BookingBankWire
 *
 * @ORM\Entity(repositoryClass="Kisaan\CoreBundle\Repository\BookingBankWireRepository")
 *
...
class BookingBankWire extends BaseBookingBankWire
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\UserBundle\Entity\User", inversedBy="bookingBankWires")
    ...
    /**
     * @ORM\OneToOne(targetEntity="Kisaan\CoreBundle\Entity\Booking", inversedBy="bankWire")
