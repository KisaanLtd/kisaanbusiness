...
use Kisaan\CoreBundle\Model\BookingDepositRefundInterface;
use Kisaan\CoreBundle\Model\BookingOptionInterface;
use Kisaan\MessageBundle\Entity\Thread;
use Kisaan\ReviewBundle\Entity\Review;
use Kisaan\TimeBundle\Model\DayTimeRange;
 ...
 * Booking
 *
 * @ORM\Entity(repositoryClass="Kisaan\CoreBundle\Repository\BookingRepository")
 *
...
class Booking extends BaseBooking
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\UserBundle\Entity\User", inversedBy="bookings", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\CoreBundle\Entity\Listing", inversedBy="bookings")
    ...
    /**
     * @ORM\OneToOne(targetEntity="Kisaan\MessageBundle\Entity\Thread", mappedBy="booking", cascade={"remove"}, orphanRemoval=true)
     */
    private $thread;

    /**
     * @ORM\OneToMany(targetEntity="Kisaan\ReviewBundle\Entity\Review", mappedBy="booking", cascade={"remove"}, orphanRemoval=true)
     */
    private $reviews;

    /**
     * @ORM\OneToOne(targetEntity="Kisaan\CoreBundle\Entity\BookingBankWire", mappedBy="booking", cascade={"remove"}, orphanRemoval=true)
     *
     * @var BookingBankWire
     **/
    private $bankWire;
    ...
    /**
     * @ORM\OneToOne(targetEntity="Kisaan\CoreBundle\Entity\BookingPayinRefund", mappedBy="booking", cascade={"remove"}, orphanRemoval=true)
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Model\BookingOptionInterface", mappedBy="booking", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $options;

    /**
     * @ORM\OneToOne(targetEntity="Kisaan\CoreBundle\Entity\BookingUserAddress", mappedBy="booking", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $userAddress;

    /**
     * @ORM\OneToOne(targetEntity="Kisaan\CoreBundle\Model\BookingDepositRefundInterface", mappedBy="booking", cascade={"remove"}, orphanRemoval=true)
     **/
     ...
     * kisaan.booking.validated_moment and kisaan.booking.validated_delay parameters.
