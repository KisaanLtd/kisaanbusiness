...
use Kisaan\CoreBundle\Model\BaseListingCharacteristic;
 ...
 *
 * @ORM\Entity(repositoryClass="Kisaan\CoreBundle\Repository\ListingCharacteristicRepository")
 *
...
class ListingCharacteristic extends BaseListingCharacteristic
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\CoreBundle\Entity\ListingCharacteristicType", inversedBy="listingCharacteristics")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\CoreBundle\Entity\ListingCharacteristicGroup", inversedBy="listingCharacteristics", fetch="EAGER")
     ...
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingCharacteristicType $listingCharacteristicType
     * @return ListingCharacteristic
     */
     ...
     *
     * @return \Kisaan\CoreBundle\Entity\ListingCharacteristicType
     */
     ...
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingCharacteristicGroup $listingCharacteristicGroup
     * @return ListingCharacteristic
     */
     ...
     *
     * @return \Kisaan\CoreBundle\Entity\ListingCharacteristicGroup
     */
