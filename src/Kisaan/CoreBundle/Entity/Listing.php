...
use Kisaan\CoreBundle\Model\BaseListing;
use Kisaan\CoreBundle\Model\ListingOptionInterface;
 ...
 * Listing
 *
 * @ORM\Entity(repositoryClass="Kisaan\CoreBundle\Repository\ListingRepository")
 *
...
class Listing extends BaseListing
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Kisaan\UserBundle\Entity\User", inversedBy="listings", cascade={"persist"})
    ...
    /**
     * For Asserts @see \Kisaan\CoreBundle\Validator\Constraints\ListingValidator
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Kisaan\MessageBundle\Entity\Thread", mappedBy="listing", cascade={"remove"}, orphanRemoval=true)
     * @ORM\OrderBy({"createdAt" = "desc"})
     */
    private $threads;
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="Kisaan\CoreBundle\Model\ListingOptionInterface", mappedBy="listing", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    private $options;
     ...
     * Add characteristics
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingListingCharacteristic $listingListingCharacteristic
     * @return Listing
     */
     ...
     * Add category
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingListingCategory $listingListingCategory
     * @return Listing
     */
...
//        }
     ...
     * Set user
     *
     * @param  \Kisaan\UserBundle\Entity\User $user
     * @return Listing
     */
     ...
     * Add images
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingImage $image
     * @return Listing
     */
     ...
     * Set location
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingLocation $location
     * @return Listing
     */
     ...
     * Get location
     *
     * @return \Kisaan\CoreBundle\Entity\ListingLocation
     */
     ...
     * Add discount
     *
     * @param  \Kisaan\CoreBundle\Entity\ListingDiscount $discount
     * @return Listing
     */
     ...
     * Add thread
     *
     * @param \Kisaan\MessageBundle\Entity\Thread $thread
     *
     * @return Listing
     */
