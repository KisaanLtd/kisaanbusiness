...
use Kisaan\CoreBundle\Model\BaseListingListingCharacteristic;
...
class ListingListingCharacteristic extends BaseListingListingCharacteristic
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\CoreBundle\Entity\ListingCharacteristic", inversedBy="listingListingCharacteristics", fetch="EAGER")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kisaan\CoreBundle\Entity\ListingCharacteristicValue", inversedBy="listingListingCharacteristics", fetch="EAGER")
