...
class LanguageController extends Controller
{
    ...
    public function switchAction(Request $request)
    {
        ...
        $languagesLinks = $this->get('kisaan.language.manager')
            ->getLanguageLinks($routeName, $routeParams, $queryString);

        return $this->render(
            '@KisaanCore/Frontend/Common/language_switcher.html.twig',
            array(
     ...
     *
     * @Route("/translate", name="kisaan_language_translate")
     * @Method({"POST"})
     *
     * @param Request $request
     *
    ...
    public function translateDataAction(Request $request)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            $translateManager = $this->get('kisaan.translator.manager');
