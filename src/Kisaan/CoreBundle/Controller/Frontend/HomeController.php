...
class HomeController extends Controller
{
    ...
    {
        $listings = $this->get("kisaan.listing_search.manager")->getHighestRanked(
        ...
        return $this->render(
            'KisaanCoreBundle:Frontend\Home:index.html.twig',
            array(
    ...
    {
        $feed = $this->getParameter('kisaan.home_rss_feed');
        if (!$feed) {
            return new Response();
        }
        ...
        return $this->render(
            'KisaanCoreBundle:Frontend/Home:rss_feed.html.twig',
            array(
                'feeds' => $renderFeeds,
            )
        );
