...
class ListingAvailabilityController extends Controller
{
     ...
     *      name="kisaan_listing_availabilities",
     *      requirements={
     *          "listing_id" = "\d+",
    ...
    public function indexAction(Request $request, Listing $listing = null, $start, $end)
    {
        ...
        $availabilities = $this->get("kisaan.listing_availability.manager")->getCalendarEvents(
            $listing->getId(),
            $start,
            $end,
            false,
        ...
        $coreExtension = $this->get('kisaan.twig.core_extension');
        array_walk(
            $availabilities,
