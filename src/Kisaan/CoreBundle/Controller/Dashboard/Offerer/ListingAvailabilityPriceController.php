...
use Kisaan\CoreBundle\Form\Type\Dashboard\ListingEditAvailabilitiesPricesType;
use Kisaan\CoreBundle\Form\Type\Dashboard\ListingEditAvailabilityPriceType;
use DateTime;
...
class ListingAvailabilityPriceController extends Controller
{
     ...
     *      name="kisaan_dashboard_listing_edit_availabilities_prices",
    ...
    {
        $listingAvailabilityHandler = $this->get('kisaan.form.handler.listing_availability.price.dashboard');
        ...
        if ($success == 1) {
            ...
            return $this->redirectToRoute(
                'kisaan_dashboard_listing_edit_availabilities_prices',
        ...
        return $this->render(
            'KisaanCoreBundle:Dashboard/Listing:edit_availabilities_prices.html.twig',
            array(
                'listing' => $listing,
     ...
     *      name="kisaan_dashboard_listing_edit_availability_price",
     *      requirements={
     *          "listing_id" = "\d+",
    ...
    public function editAvailabilityPriceAction(
        ...
        return $this->render(
            'KisaanCoreBundle:Dashboard/Listing:form_availability_price.html.twig',
            array(
    ...
    private function createEditAvailabilityPriceForm($listingId, $day, $startTime, $endTime)
    {
        $form = $this->get('form.factory')->createNamed(
            ...
            array(
                'method' => 'POST',
                'action' => $this->generateUrl(
                    'kisaan_dashboard_listing_edit_availability_price',
                    array(
     ...
     *      name="kisaan_dashboard_listing_new_availability_price",
     *      requirements={
     *          "listing_id" = "\d+",
     *          "day"= "^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$"
     *      },
    ...
    private function createCreateForm(ListingAvailability $availability)
    {
        $form = $this->get('form.factory')->createNamed(
            ...
            array(
                'method' => 'POST',
                'action' => $this->generateUrl(
                    'kisaan_dashboard_listing_new_availability_price',
                    array(
