...
class BookingBankWireController extends Controller
{
     ...
     *
     * @Route("/{page}", name="kisaan_dashboard_booking_bank_wire_offerer", defaults={"page" = 1})
     * @Method("GET")
     *
    ...
    {
        $bookingBankWireManager = $this->get('kisaan.booking_bank_wire.manager');
        ...
        return $this->render(
            'KisaanCoreBundle:Dashboard/BookingBankWire:index.html.twig',
            array(
     ...
     *
     * @Route("/{id}/show-bill", name="kisaan_dashboard_booking_bank_wire_show_bill_offerer", requirements={"id" = "\d+"})
     * @Method("GET")
     *
     * @param  int $id
     *
    ...
    public function showBillAction($id)
    {
        ...
        return $this->render(
            'KisaanCoreBundle:Dashboard/BookingBankWire:show_bill.html.twig',
            array(
