...
use Kisaan\CoreBundle\Event\ListingSearchFormBuilderEvent;
use Kisaan\CoreBundle\Event\ListingSearchFormEvents;
use Kisaan\CoreBundle\Form\Type\ListingCategoryType;
use Kisaan\CoreBundle\Form\Type\ListingCharacteristicType;
use Kisaan\CoreBundle\Form\Type\PriceRangeType;
use Kisaan\CoreBundle\Model\ListingSearchRequest;
use Kisaan\CoreBundle\Repository\ListingCategoryRepository;
use Kisaan\TimeBundle\Form\Type\DateRangeType;
use Kisaan\TimeBundle\Form\Type\TimeRangeType;
use Kisaan\TimeBundle\Model\DateRange;
...
class ListingSearchResultType extends AbstractType
{
    ...
    public function __construct(
        ...
        $this->timeUnitIsDay = ($parameters['kisaan_time_unit'] % 1440 == 0) ? true : false;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $categoryRepository = $this->entityManager->getRepository("KisaanCoreBundle:ListingCategory");
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults(
            array(
                ...
                'data_class' => 'Kisaan\CoreBundle\Model\ListingSearchRequest',
