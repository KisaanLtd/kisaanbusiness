...
namespace Kisaan\CoreBundle\Request;

use Kisaan\CoreBundle\Event\ListingEvent;
use Kisaan\CoreBundle\Event\ListingEvents;
...
class ListingParamConverter implements ParamConverterInterface
{
    ...
    public function apply(Request $request, ParamConverter $configuration)
    {
        ...
        if (!isset($class) || $class != "Kisaan\CoreBundle\Entity\Listing") {
            return false;
        }
        ...
        $queryBuilder = $this->em->getRepository("KisaanCoreBundle:Listing")->getFindOneBySlugQuery($slug, $locale);
...
//            $object = $this->em->getRepository("KisaanCoreBundle:Listing")->findOneBySlug($slug, $locale);
    ...
    {
        return $configuration->getClass() == 'Kisaan\CoreBundle\Entity\Listing';
    }
