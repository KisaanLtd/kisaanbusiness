...
class ListingAvailabilityParamConverter implements ParamConverterInterface
{
    ...
    public function apply(Request $request, ParamConverter $configuration)
    {
        ...
        if (!isset($class) || $class != "Kisaan\CoreBundle\Document\ListingAvailability") {
            return false;
        }
        ...
        try {
            $object = $this->dm->find("Kisaan\CoreBundle\Document\ListingAvailability", $id);
    ...
    {
        return $configuration->getClass() == 'Kisaan\CoreBundle\Document\ListingAvailability';
    }
