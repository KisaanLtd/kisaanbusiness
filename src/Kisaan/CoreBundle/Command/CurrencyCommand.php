...
//Cron: 30 17  * * *  user   php bin/console kisaan:currency:update
...
class CurrencyCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (count($result)) {
            ...
            $file = $this->getContainer()->getParameter('kisaan.currencies_json');
