...
class MigrateBookingsDatesCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('kisaan:bookings:migrate-dates')
            ->setDescription('Migrate booking dates.')
            ->setHelp("Usage php bin/console kisaan:bookings:migrate-dates");
    }

    /** @inheritdoc */
    public function execute(InputInterface $input, OutputInterface $output)
    {
        $bookingManager = $this->getContainer()->get('kisaan.booking.manager');
