...
//Cron: 0 */1  * * *  user   php app/console kisaan:bookings:expire
...
class ExpireBookingsCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('kisaan:bookings:expire')
            ...
            ->setHelp("Usage php bin/console kisaan:bookings:expire");
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $result = $this->getContainer()->get('kisaan.booking.manager')->expireBookings(
            $expirationDelay,
            $acceptationDelay
        );
