...
//Cron: */15 * * * *  user   php app/console kisaan:bookings:alertExpiring
...
class AlertExpiringBookingsCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('kisaan:bookings:alertExpiring')
            ...
            ->setHelp("Usage php bin/console kisaan:bookings:alertExpiring");
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $alertDelay = $this->getContainer()->getParameter('kisaan.booking.alert_expiration_delay');
        ...
        $result = $this->getContainer()->get('kisaan.booking.manager')
