...
use Kisaan\CoreBundle\Model\ListingCategoryFieldValueInterface;
...
use Kisaan\CoreBundle\Repository\ListingCharacteristicRepository;
use Kisaan\CoreBundle\Repository\ListingRepository;
...
class ListingManager extends BaseManager
{
    ...
    public function refreshListingListingCharacteristics(Listing $listing)
    {
        ...
        $listingCharacteristicRepository = $this->em->getRepository('KisaanCoreBundle:ListingCharacteristic');
    ...
    public function addCategories(Listing $listing, array $categories, array $values)
    {
        foreach ($categories as $i => $category) {
            ...
            $listingCategory = $this->em->getRepository('KisaanCoreBundle:ListingCategory')->findOneById(
                $category
            );
            ...
            if ($listingCategory->getFields()) {
                foreach ($listingCategory->getFields() as $field) {
                    ...
                    $fieldValue = new \Kisaan\ListingCategoryFieldBundle\Entity\ListingCategoryFieldValue();
    ...
    {
        return $this->em->getRepository('KisaanCoreBundle:Listing');
    }
