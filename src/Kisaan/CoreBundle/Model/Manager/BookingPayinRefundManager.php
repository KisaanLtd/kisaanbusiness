...
use Kisaan\CoreBundle\Repository\BookingPayinRefundRepository;
...
class BookingPayinRefundManager extends BaseManager
{
    ...
    {
        return isset($this->bundles["KisaanListingDepositBundle"]);
    }
    ...
    {
        return $this->em->getRepository('KisaanCoreBundle:BookingPayinRefund');
    }
