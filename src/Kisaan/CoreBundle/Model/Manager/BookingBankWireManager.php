...
use Kisaan\CoreBundle\Event\BookingBankWireEvent;
use Kisaan\CoreBundle\Event\BookingBankWireEvents;
use Kisaan\CoreBundle\Mailer\TwigSwiftMailer;
use Kisaan\CoreBundle\Repository\BookingBankWireRepository;
...
class BookingBankWireManager extends BaseManager
{
    ...
    {
        return $this->em->getRepository('KisaanCoreBundle:BookingBankWire');
    }
