...
use Kisaan\TimeBundle\Form\DataTransformer\TimeRangeViewTransformer;
use Kisaan\TimeBundle\Model\DateRange;
use Kisaan\TimeBundle\Model\TimeRange;
use Kisaan\TimeBundle\Validator\TimeRangeValidator;
...
//                                    'data' => $options['time_unit']
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Kisaan\TimeBundle\Model\TimeRange',
                'start_options' => array(),
                'end_options' => array(),
                'transformer' => null,
                'validator' => null,
