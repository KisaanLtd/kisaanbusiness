...
use Kisaan\TimeBundle\Form\DataTransformer\DateRangeViewTransformer;
use Kisaan\TimeBundle\Model\DateRange;
use Kisaan\TimeBundle\Validator\DateRangeValidator;
...
class DateRangeType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Kisaan\TimeBundle\Model\DateRange',
                'end_options' => array(),
                'start_options' => array(),
//                'transformer' => null,
//                'validator' => null,
