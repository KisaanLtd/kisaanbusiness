...
namespace Kisaan\TimeBundle\Validator;
...
class DateRangeValidator implements EventSubscriberInterface, TranslationContainerInterface
{
    ...
    {
        $messages[] = new Message("date_range.invalid.end_in_past", 'kisaan');
        $messages[] = new Message("date_range.invalid.min_start {{ min_start_day }}", 'kisaan');
        $messages[] = new Message("date_range.invalid.max_end {{ date_max }}", 'kisaan');
        $messages[] = new Message("date_range.invalid.single_day", 'kisaan');
        $messages[] = new Message("date_range.invalid.end_before_start", 'kisaan');
        $messages[] = new Message("date_range.invalid.required", 'kisaan');
