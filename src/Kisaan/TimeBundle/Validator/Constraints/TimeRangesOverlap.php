...
namespace Kisaan\TimeBundle\Validator\Constraints;
...
class TimeRangesOverlap extends Constraint implements TranslationContainerInterface
{
    ...
    {
        $messages = array();
        $messages[] = new Message(self::$messageOverlap, 'kisaan_listing');
        $messages[] = new Message(self::$messageMin, 'kisaan_listing');
        $messages[] = new Message(self::$messageMax, 'kisaan_listing');
