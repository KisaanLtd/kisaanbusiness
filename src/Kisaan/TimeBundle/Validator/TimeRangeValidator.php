...
//            }
    ...
    {
        $messages = array();
        $messages[] = new Message("time_range.invalid.required", 'kisaan');
        $messages[] = new Message("time_range.invalid.end_before_start", 'kisaan');
        $messages[] = new Message("time_range.invalid.single_time", 'kisaan');
        $messages[] = new Message("time_range.invalid.duration", 'kisaan');
        $messages[] = new Message("time_range.invalid.min_start {{ min_start_time }}", 'kisaan');
