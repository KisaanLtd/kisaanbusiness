...
namespace Kisaan\MessageBundle\Form\Type\Frontend;
...
class NewThreadMessageFormType extends AbstractType implements TranslationContainerInterface
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add(
                ...
                array('class' => 'Kisaan\CoreBundle\Entity\Listing')
            )
            ->add(
                'recipient',
                EntityHiddenType::class,
                array('class' => 'Kisaan\UserBundle\Entity\User')
            )
            ->add(
                'subject',
                HiddenType::class,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            array(
//                'data_class' => 'Kisaan\MessageBundle\Entity\Thread',
