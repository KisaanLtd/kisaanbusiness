...
use Kisaan\ReportBundle\Repository\ListingRepository;
...
class ThreadAdmin extends AbstractAdmin
{
        ...
        $listMapper
            ...
            ->add(
                ...
                array(
                    ...
                    'template' => 'KisaanMessageBundle:Admin:thread_type.html.twig'
                )
            )
            ->add(
                'booking',
            ...
            ->add(
                ...
                array(
                    ...
                    'template' => 'KisaanMessageBundle:Admin:view_thread.html.twig'
                )
            );
    ...
    public function getFormTheme()
    {
        return array_merge(
            parent::getFormTheme(),
            array('KisaanMessageBundle:Admin:message_body.html.twig')
        );
    }
