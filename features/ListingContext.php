...
class ListingContext extends CommonContext
{
    ...
    /**
     * @param $title
     * @return \Kisaan\CoreBundle\Entity\Listing|null
     */
    public function getListingByTitle($title)
    {
        $em = $this->getEntityManager();

        /** @var $entity \Kisaan\CoreBundle\Entity\Listing */
        $entity = $em->getRepository('KisaanCoreBundle:Listing')->findOneByTitle(
            $title,
            $this->getContainer()->getParameter('kisaan.locale')
        );
