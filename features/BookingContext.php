...
class BookingContext extends CommonContext
{
    ...
    public function AdminMakeABankWire()
    {
        ...
        $this->pageContext->iShouldBeOnThePageNamed("admin_kisaan_core_bookingbankwire_list");

        $this->pageContext->iClickOnTheElementWithCSSSelector("a.sonata-link-identifier");
        $this->pageContext->iShouldBeOnThePageNamed("admin_kisaan_core_bookingbankwire_edit");
...
//        $this->pageContext->iShouldBeOnTheUrl("https://api.sandbox.mangopay.com/authorize?response_type=code&client_id=mangoapps&redirect_uri=https://dashboard.sandbox.mangopay.com/Authorize/SignIn");
        ...
        $this->fillField("PartnerId", $this->getContainer()->getParameter("kisaan_mangopay.client_id"));
        $this->fillField("Email", $this->getContainer()->getParameter("kisaan_mangopay.dashboard_email"));
        $this->fillField("Password", $this->getContainer()->getParameter("kisaan_mangopay.dashboard_password"));
        $this->pageContext->iPressButtonWithCSSSelector("button.btn-sm");
        $this->pageContext->iShouldBeOnTheUrl($this->getContainer()->getParameter("kisaan_mangopay.dashboard_url"));
        $this->visitPath($this->getContainer()->getParameter("kisaan_mangopay.dashboard_operations_payout_url"));
        ...
        $this->pageContext->iAmOnThePage("admin_kisaan_core_bookingbankwire_list");
        $this->pageContext->iClickOnTheElementWithCSSSelector("a.sonata-link-identifier");
